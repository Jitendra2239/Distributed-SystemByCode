...
public class GlobalFunc extends Process implements GlobalService {
    ...
    public GlobalFunc(Linker initComm, boolean isRoot) throws IOException {
        super(initComm);
    ...
    public synchronized int computeGlobal() throws IOException {
    ...
    void sendChildren(int value) throws IOException {
